...
class ResetPasswordSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if old_password is None:
            raise serializers.ValidationError('The old password is required to reset the password.')
        if new_password is None:
            raise serializers.ValidationError('The new password is required to reset the password.')
        return data
